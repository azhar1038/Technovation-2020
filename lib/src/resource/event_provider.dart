          ...
          [
            EventModel.fromJson({
              ...
              "rules": [
                ...
                "Every team will be required to face interaction via questions from the audience after the walk."
...
//                "On the basis of Interaction with the audience"
            ...
            EventModel.fromJson({
              ...
              "rules": [
                "The picture should not have any effect and it should be less than 10 MB",
                "Top participants from boys and from girls will be selected on the basis of the number of likes they get.",
                "The further rounds will have many twists and turns.",
                "Winner of the event will be decided based on the further rounds.",
                "Use of auto likers is not allowed and may lead to disqualification",
                "Winners of the first round will be announced on the page."
              ],
              "coordinators": ["Prasant Kumar Dey", "Monalisha Sahoo"],
              "coordinatorsNumber": ["7789890440", "7788818623"],
              "judgement": []
            ...
            EventModel.fromJson({
              ...
              "rules": [
                ...
                "Props can be used.",
                "Team members can be boys, gi rls, or mix.",
